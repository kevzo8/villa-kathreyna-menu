...
import { rice, sandwiches, desserts } from "@/lib/menu-data"

export function PageRiceSandwichesDesserts() {
  return (
    <div className="menu-page w-[210mm] h-[297mm] mx-auto relative bg-[#faf8f3] overflow-hidden flex flex-col" data-page-name="rice-sandwiches-desserts">
      {/* Corner accents */}
      ...
      <PageBanner imageSrc="/images/banners/breakfast-savers.jpg" alt="Rice, Snacks & Sandwiches, Desserts" />

      <div className="px-7 flex-1 flex flex-col pt-2 gap-1.5">
        {/* Rice */}
        ...
        {/* Snacks & Sandwiches */}
        <SectionHeader title={sandwiches.title} />
